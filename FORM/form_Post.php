<?php
    ...
    function filterData($section){
        ...
        if(empty($error)){         
            if($section == 'account'){
                ...
                if( isset($_POST['update']) && isset($_GET['editbtn']) ){
                    $id = array_search('edit', $_GET['editbtn']);
                    update($id, $table, $data);
                }
                else if( isset($_POST['submit']) && !(isset($_GET['editbtn']))){
                    insert($table, $data);
                }                             
            }
                ...
                foreach($_POST[$section] as $key => $value ){
                    ...
                    if(is_array($value)){
                        ...
                        if( isset($_POST['update']) && isset($_GET['editbtn'])){
                            $cust_id = array_search('edit',$_GET['editbtn']);
                            updateOther($cust_id,$table,$data);
                        }
                        else if(isset($_POST['submit'])  && !(isset($_GET['editbtn'])) ){
                            insert($table,$data);
                        } 
    ...
    if(isset($_POST['submit'])  && (isset($_GET['editbtn']))){
        echo "<br><b>You Should have to Click Update Button not Submit Button </b>";
    }
    if(isset($_GET['deletebtn'])){
        $id = array_search('delete',$_GET['deletebtn']); 
        deleteData($id,'customer_address');
        deleteData($id,'customer_additional_info');
        deleteData($id,'customers');
    }    
?>