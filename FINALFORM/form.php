...
<html>
    ...
    ?>
            ...
            <div id="AccountDetails">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" name="account[confirmPassword]" value="<?php echo displayValue('account','confirmPassword');?>">
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <?php
            ...
            echo "<th>FirstName</th><th>email</th><th>City</th><th>Hobbies</th><th>GET In Touch</th></tr>";
            $result = temp();
            ...
            // displayField('customer_address');
            // displayField('customer_additional_info');
            // display('customers');
            // display('customer_address');
            // display('customer_additional_info');
